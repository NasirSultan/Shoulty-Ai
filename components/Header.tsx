        ...
        columns: [
            {
                ...
                items: [
                    ...
                    { label: "Interior Design", href: "/interior.html", icon: ShoppingBag },
                    { label: "Footwear", href: "/digital-marketing-for-footwear-brands.html", icon: HeartPulse },
                    { label: "Real Estate", href: "/marketing-for-builders-and-developers.html", icon: Building2 },
                    { label: "Startups", href: "/Business-Consultant.html", icon: Rocket },
                    ...
                    { label: "Makeup Services", href: "/perfume.html", icon: Landmark },
                ],
            },
            {
                title: "By channel",
