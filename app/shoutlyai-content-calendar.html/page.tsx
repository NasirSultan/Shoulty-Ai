...
const FILE_NAME = "shoutlyai-content-calendar.html";
const SCOPE_CLASS = "content-calendar-content";
  ...
  return (
    <main className="bg-white text-slate-900">
      ...
      {inlineScripts.map((scriptContent, index) => (
        <Script
          key={`content-calendar-inline-script-${index}`}
          id={`content-calendar-inline-script-${index}`}
